...
Uniti::Object &Animation::getObject() {
    return this->_object;
}
...
void Animation::preUpdate() {
    ...
    if (this->_clock.getSeconds() < this->_animations[this->_actualAnimation].secondRemaining) return;
    ...
    this->_object.emitEvent("changeTextureRect", this->_animations[this->_actualAnimation].frames[this->_iteration]);
    this->_clock.restart();
}
...
const Uniti::Clock &Animation::getClock() const {
    return this->_clock;
}

Uniti::Clock &Animation::getClock() {
    return this->_clock;
}

const Uniti::Event &Animation::getEvent() const {
    return this->_event;
}

Uniti::Event &Animation::getEvent() {
    return this->_event;
}
...
void *getCreator(void) {
    return new Uniti::PluginCreator<Uniti::IObjectPlugin, Animation, Uniti::Object>();
}

void deleteCreator(void *creator) {
    delete static_cast<Uniti::PluginCreator<Uniti::IObjectPlugin, Animation, Uniti::Object> *>(creator);
}
}
