...
Uniti::Object &PlayerController::getObject() {
    return this->_object;
}
...
const Uniti::Clock &PlayerController::getClock() const {
    return this->_clock;
}

Uniti::Clock &PlayerController::getClock() {
    return this->_clock;
}

const Uniti::Event &PlayerController::getEvent() const {
    return this->_event;
}

Uniti::Event &PlayerController::getEvent() {
    return this->_event;
}

extern "C" {
void *getCreator(void) {
    return new Uniti::PluginCreator<Uniti::IObjectPlugin, PlayerController, Uniti::Object>();
}

void deleteCreator(void *creator) {
    delete static_cast<Uniti::PluginCreator<Uniti::IObjectPlugin, PlayerController, Uniti::Object> *>(creator);
}
}
