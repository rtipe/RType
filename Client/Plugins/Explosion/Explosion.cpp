...
Uniti::Object &Explosion::getObject() { return this->_object; }
...
void Explosion::update() {
  if (this->_clock.getSeconds() < this->_timeBeforeExplosion)
    return;
  this->_clock.restart();
...
const Uniti::Clock &Explosion::getClock() const { return this->_clock; }

Uniti::Clock &Explosion::getClock() { return this->_clock; }

const Uniti::Event &Explosion::getEvent() const { return this->_event; }

Uniti::Event &Explosion::getEvent() { return this->_event; }

extern "C" {
void *getCreator(void) {
  return new Uniti::PluginCreator<Uniti::IObjectPlugin, Explosion,
                                  Uniti::Object>();
}

void deleteCreator(void *creator) {
  delete static_cast<
      Uniti::PluginCreator<Uniti::IObjectPlugin, Explosion, Uniti::Object> *>(
      creator);
}
}